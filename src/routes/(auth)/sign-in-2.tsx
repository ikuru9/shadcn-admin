...
import dashboardDark from "./components/assets/dashboard-dark.png";
import dashboardLight from "./components/assets/dashboard-light.png";
import { UserAuthForm } from "./components/user-auth-form";

function SignIn2() {
  return (
    <div className="container relative grid h-sh flex-col items-center justify-center lg:max-w-none lg:grid-cols-2 lg:px-0">
