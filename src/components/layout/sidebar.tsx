...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      setCookie(SIDEBAR_COOKIE_NAME, openState ? "1" : "0", SIDEBAR_COOKIE_MAX_AGE);
    },
    [setOpenProp, open],
  );
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          "group-data-[collapsible=off-canvas]:w-0",
      ...
      <div
        ...
        data-side={side}
        className={cn(
          "fixed inset-y-0 z-10 hidden h-sh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear data-[side=right]:right-0 data-[side=left]:left-0 data-[side=right]:group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] data-[side=left]:group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] md:flex",
