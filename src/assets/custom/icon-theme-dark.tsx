...
export function IconThemeDark(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M22.88 0h52.97c2.21 0 4 1.79 4 4v43.14c0 2.21-1.79 4-4 4H22.88V0z" fill="#1e3932" />
      <circle cx={6.7} cy={7.04} r={3.54} fill="#d4e9e2" />
      <path
      ...
      <circle cx={62.74} cy={16.32} r={8} fill="#00754a" opacity={0.5} />
      <path
        d="M62.74 16.32l4.1-6.87c1.19.71 2.18 1.72 2.86 2.92s1.04 2.57 1.04 3.95h-8z"
        fill="#d4e9e2"
        opacity={0.74}
      />
      <rect x={29.64} y={27.75} width={41.62} height={18.62} rx={1.69} ry={1.69} fill="#2b5148" />
    </svg>
  );
}
