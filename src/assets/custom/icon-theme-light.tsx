...
export function IconThemeLight(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M22.88 0h52.97c2.21 0 4 1.79 4 4v43.14c0 2.21-1.79 4-4 4H22.88V0z" fill="#f2f0eb" />
      <circle cx={6.7} cy={7.04} r={3.54} fill="#006241" />
      <path
      ...
      <circle cx={62.74} cy={16.32} r={8} fill="#d4e9e2" />
      <g fill="#00754a">
      ...
      <rect x={29.64} y={27.75} width={41.62} height={18.62} rx={1.69} ry={1.69} fill="#ffffff" />
    </svg>
  );
}
