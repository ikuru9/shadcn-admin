...
members: [
{ name: "{teammate-1}", agent_type: "{type}", model: "openai/gpt-5.4", prompt: "{역할 설명 및 작업 지시}" },
{ name: "{teammate-2}", agent_type: "{type}", model: "openai/gpt-5.4", prompt: "{역할 설명 및 작업 지시}" },
...
]
)
...
| --------- | ------ | ------------------------------------------ | -------------- | ----------------- |
| {agent-1} | {소스} | `_workspace/{phase}_{agent}_{artifact}.md` | openai/gpt-5.4 | true              |
| {agent-2} | {소스} | `_workspace/{phase}_{agent}_{artifact}.md` | openai/gpt-5.4 | true              |
