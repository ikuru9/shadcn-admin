...
Keywords: React, JSX, hooks, useState, useEffect, use(), Suspense, RSC.
triggers:
  - React
  - JSX
  - hooks
...
- Implementing state management (local, Context, Zustand)
...
| State Management | `references/state-management.md` | Context, Zustand, TanStack |
...
React 19, Server Components, use() hook, Suspense, TypeScript, TanStack Query, Zustand, React Router, React Testing Library, Vitest/Jest, Next.js App Router, accessibility (WCAG)
